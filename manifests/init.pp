...
class logstashforwarder(
  ...
  Variant[Boolean, String] $version                 = false,
  String $package_provider        = 'package',
  Optional[String] $package_url             = undef,
  String $package_dir             = $logstashforwarder::params::package_dir,
  Boolean $purge_package_dir       = $logstashforwarder::params::purge_package_dir,
  Integer $package_dl_timeout      = $logstashforwarder::params::package_dl_timeout,
  ...
  Variant[Hash, Undef] $init_defaults           = $logstashforwarder::params::init_defaults,
